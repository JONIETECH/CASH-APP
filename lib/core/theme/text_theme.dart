...
class FTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleSmall: TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.w400, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleSmall: TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.w400, color:  Colors.white),
