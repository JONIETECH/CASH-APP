    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.fromLTRB(20.0, 0.0, 20.0, 8.0), // Add space between the input fields
              child: TextField(
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(20.0, 8.0, 20.0, 0.0), // Add space between the input fields
              child: TextField(
                controller: amountController,
                keyboardType: TextInputType.number,
                decoration: const InputDecoration(
                  labelText: 'Amount',
                  contentPadding: EdgeInsets.only(left: 15.0), // Control the height of the input field
                ),
              ),
            ),
            TextButton(
              style: TextButton.styleFrom(foregroundColor: Theme.of(context).colorScheme.surface, backgroundColor: Theme.of(context).colorScheme.inverseSurface),
              onPressed: () async {
  ...
  List<Map<String, String>> _filteredTransactions() {
    ...
    return transactions.where((transaction) {
      ...
      if (_searchQuery.isNotEmpty) {
        matchesFilter = matchesFilter && transaction['name']!.toLowerCase().contains(_searchQuery.toLowerCase());
      }
